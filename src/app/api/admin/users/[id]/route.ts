...
export async function DELETE(
    ...
    try {
        ...
        // 1. Verify caller is an admin via Authorization header
        ...
        // 2. Delete user from auth.users via Supabase Admin API
        ...
        // 3. Delete from public.users (just in case cascade isn't setup)
